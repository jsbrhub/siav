...
class InsumosBDBase {
    ...
    function inserir($oInsumos){
		$reg = InsumosMAP::objToRs($oInsumos);
	...
	function get($idInsumo){
        ...
        try{
            ...
            if($this->oConexao->numRows() != 0){
                ...
                return InsumosMAP::rsToObj($aReg);
            } else {
