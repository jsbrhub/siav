<?php
class TermoresponsabilidadeMAP {

	static function getMetaData() {
		return ['termoresponsabilidade' => ['idTermo', 
'idCampanha', 
'idEmpresa', 
'cnpj', 
'comprovante', 
...
'usuarioAlteracao']];
	...
	static function objToRs($oTermoresponsabilidade){
		$reg['idTermo'] = $oTermoresponsabilidade->idTermo;
		$oCampanha = $oTermoresponsabilidade->oCampanha;
		$reg['idCampanha'] = $oCampanha->idCampanha;
		$oEmpresa = $oTermoresponsabilidade->oEmpresa;
		$reg['idEmpresa'] = $oEmpresa->idEmpresa;
		$reg['cnpj'] = $oTermoresponsabilidade->cnpj;
		$reg['comprovante'] = $oTermoresponsabilidade->comprovante;
		$reg['dataHoraAlteracao'] = $oTermoresponsabilidade->dataHoraAlteracao;
		$reg['usuarioAlteracao'] = $oTermoresponsabilidade->usuarioAlteracao;
		return $reg;		   
	}

	static function objToRsInsert($oTermoresponsabilidade){
		$oCampanha = $oTermoresponsabilidade->oCampanha;
		$reg['idCampanha'] = $oCampanha->idCampanha;
		$oEmpresa = $oTermoresponsabilidade->oEmpresa;
		$reg['idEmpresa'] = $oEmpresa->idEmpresa;
	...
	static function rsToObj($reg){
		...
		$oTermoresponsabilidade = new Termoresponsabilidade();
		$oTermoresponsabilidade->idTermo = $reg['termoresponsabilidade_idTermo'];
		...
		$oTermoresponsabilidade->oCampanha = $oCampanha;
		...
		$oTermoresponsabilidade->oEmpresa = $oEmpresa;
		$oTermoresponsabilidade->cnpj = $reg['termoresponsabilidade_cnpj'];
		$oTermoresponsabilidade->comprovante = $reg['termoresponsabilidade_comprovante'];
		$oTermoresponsabilidade->dataHoraAlteracao = $reg['termoresponsabilidade_dataHoraAlteracao'];
		$oTermoresponsabilidade->usuarioAlteracao = $reg['termoresponsabilidade_usuarioAlteracao'];
		return $oTermoresponsabilidade;		   
	}
}
