    ...
    <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="empresa"><span class="glyphicon glyphicon-home"></span> Home</a></li>
                <?php
...
<!--                                    Retificações Pendentes</a></li>-->
                    ...
                    <li class=""><a href="docs/ManualUsuarioSIAV.pdf" target="_blank"><span class="glyphicon glyphicon-info-sign"></span> Manual do Usuário Empresa</a></li>
                    <li class=""><a href="/arquivos" target="_blank"><span class="glyphicon glyphicon-folder-open"></span> &nbsp;&nbsp;Arquivos úteis</a></li>
                    <li class=""><a href="relatorio-campanha"><span class="glyphicon glyphicon-graph"></span> &nbsp;&nbsp;Relatório Campanha</a></li>
                    <?php
                }else{
                ?>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
<!--                            <li>-->
<!--                                <a href="empresa"><i class="glyphicon glyphicon-asterisk"></i> Atualizações Cadastrais</a>-->
<!--                            </li>-->
                            <li><a href="cadRetificacaoempresa"><i class="glyphicon glyphicon-pencil"></i> Retificação</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Assinatura <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="empresa-responsaveis"><i class="glyphicon glyphicon-search"></i> Consultar Responsáveis</a></li>
                        </ul>
                    </li>
                    <li class=""><a href="docs/ManualUsuarioSIAV.pdf" target="_blank"><span class="glyphicon glyphicon-info-sign"></span> Manual do Usuário</a></li>
                <?php
                     }
                ?>
            </ul>
